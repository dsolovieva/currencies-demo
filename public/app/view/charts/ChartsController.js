Ext.define('Currencies.view.charts.ChartsController', {
    ...
    requires: ['Ext.chart.axis.Numeric', 'Ext.chart.axis.Time', 'Ext.chart.series.Line', 'Ext.chart.interactions.ItemHighlight',
    ...
    onModeToggle: function (segmentedButton, button, pressed) {
        ...
        charts.forEach(function (chart) {
            var interactions = chart.getInteractions(), panzoom = interactions[0], value = segmentedButton.getValue(),
                isEnabled = value === 0;
    ...
    setStoreExtraParams: function (store, series) {
        ...
        store.proxy.setExtraParam("dateStart", lastDate || Date.now() - 30 * day);
        store.proxy.setExtraParam("dateEnd", Date.now());
